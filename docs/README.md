...
| [dependency-support.md](dependency-support.md) | All users | Package managers: trigger vs extraction; npm, Python, Go, Ruby, PHP, JVM, .NET, Rust, Swift shipped |
...
| [implemented/multi-ecosystem-manifest-extraction.md](features/implemented/multi-ecosystem-manifest-extraction.md) | Implemented | Non-npm parsers (Swift, PHP/NuGet lockfiles included; BOM deferred to [#11](https://github.com/kadraman/codefence/issues/11)) |
