...
| [dependency-support.md](dependency-support.md) | All users | Package managers: trigger vs extraction; npm, Python, Go, Ruby, PHP, JVM, .NET shipped |
...
| [multi-ecosystem-manifest-extraction.md](features/multi-ecosystem-manifest-extraction.md) | Partial | Non-npm parsers; Ruby, PHP, JVM, .NET shipped; Rust/Swift open |
