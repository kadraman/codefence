...
| [dependency-support.md](dependency-support.md) | All users | Package managers: trigger vs extraction; npm, Python, Go, Ruby, PHP, `*.csproj` shipped |
...
| [multi-ecosystem-manifest-extraction.md](features/multi-ecosystem-manifest-extraction.md) | Partial | Non-npm parsers; Ruby, PHP, `*.csproj` shipped; JVM/Rust/Swift open |
